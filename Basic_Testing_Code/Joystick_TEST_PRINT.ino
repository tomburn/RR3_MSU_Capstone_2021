...
BLYNK_WRITE(V10) {
 ...
 pos=(x/2);
  ...
  /*if (pos !=0){  10.4 it moves once and then disconnects from blynk. too much draw? set up breakout with power???
   * // these should also be floats! Or whatever has less precision and can update faster
  //timer.setInterval(20, moveservo);
  Serial.print("Somwthjing shoudl move");
  testservo.write(pos);
  // move servo after 2 seconds
  }//moveservo;*/
  }
